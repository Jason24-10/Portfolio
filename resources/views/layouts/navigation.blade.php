<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <!-- Responsive Navigation Menu (tampil saat hamburger dibuka) -->
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <!-- Log Out di tampilan responsive -->
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
            ...
            @else
                <!-- Jika belum login, tampilkan tombol Login & Register di mobile -->
                <div class="px-4">
                    <a href="{{ route('login') }}"
                       class="block font-medium text-base text-gray-800 hover:underline">
                        {{ __('Login') }}
                    </a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                           class="block mt-1 font-medium text-base text-gray-800 hover:underline">
                            {{ __('Register') }}
                        </a>
                    @endif
                </div>
